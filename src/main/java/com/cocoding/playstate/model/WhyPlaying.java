...
/**
 * Reasons someone picks up a game — play intent. Up to {@link #MAX_PER_GAME} per title.
 * Persisted as enum names in {@code user_games.play_intent} (CSV).
 */
public enum WhyPlaying {
    ...
    LEGACY(
            "🌀",
            "Legacy run",
            "Play through a series or revisit a franchise"),
    ...
    /**
     * Resolves persisted or request values, including legacy {@code PlayIntent} names stored before the rebrand.
     */
